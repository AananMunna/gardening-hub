      ...
      <SwiperSlide key={index}>
        ...
        >
          ...
          <div className="absolute top-20 left-10 w-16 h-16 opacity-70 animate-float1">
            <svg viewBox="0 0 512 512" className="text-emerald-300/50 dark:text-emerald-200/40">
          ...
          <div className="absolute bottom-40 right-16 w-12 h-12 opacity-60 animate-float2">
            <svg viewBox="0 0 512 512" className="text-emerald-200/60 dark:text-emerald-100/50">
              <path fill="currentColor" d="M289.58 21.55c-16.8-28.74-58.35-28.74-75.15 0C175.89 77.44 80 234.43 80 307.18a112.45 112.45 0 00224.9 0c0-72.75-95.89-229.74-15.32-285.63z"/>
            </svg>
          </div>
              ...
              <div className="max-w-2xl backdrop-blur-sm bg-white/90 dark:bg-gray-900/80 p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-gray-800/40 transform transition-all duration-700 hover:scale-[1.02]">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-medium text-green-700 dark:text-green-300">{slide.date}</span>
                  </div>
                </div>
              </div>
            </div>
