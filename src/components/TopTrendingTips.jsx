          ...
          {tips.map((tip) => (
            ...
            >
              ...
              <div className="p-5 space-y-2">
                <p
                  className="inline-flex items-center justify-center border border-gray-300 text-gray-700 text-lg font-bold px-5 py-2 rounded-md shadow-sm transition-all duration-300 ease-in-out hover:border-blue-400 hover:text-blue-600 my-2
