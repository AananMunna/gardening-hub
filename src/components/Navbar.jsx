...
export default function Navbar() {
  ...
  return (
    <nav className="sticky left-0 right-0 z-50 top-0 bg-gradient-to-r from-green-700 to-green-600 dark:from-gray-900 dark:to-gray-800 text-white shadow-lg">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center h-15">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              to="/"
              className="text-2xl font-bold font-serif tracking-wider text-white dark:text-lime-100"
            >
              GardenHub
            </Link>
          </div>
