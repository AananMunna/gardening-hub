...
const UpdateTip = () => {
  ...
  <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md border border-green-100 dark:border-green-700">
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <label className="text-sm text-gray-600 dark:text-gray-300">Plant Type/Topic</label>
        <input
          type="text"
          value={tip.topic}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label className="text-sm text-gray-600 dark:text-gray-300">Availability</label>
          <select
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="text-sm text-gray-600 dark:text-gray-300">User Name</label>
          <input
            type="text"
            value={tip.userName}
            readOnly
        ...
        <div>
          <label className="text-sm text-gray-600 dark:text-gray-300">User Email</label>
          <input
            type="email"
            value={tip.userEmail}
            readOnly
