  ...
  <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden border border-green-100 dark:border-green-700">
    ...
    <div className="p-6 md:p-10 space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-6 bg-[#f0f7ee] dark:bg-green-900/70 p-4 rounded-xl">
        <p>
          <span className="font-semibold text-[#345c2c] dark:text-green-300">Category:</span> {tipDetails.category}
        </p>
        <p>
          <span className="font-semibold text-[#345c2c] dark:text-green-300">Topic:</span> {tipDetails.topic}
        </p>
        <p>
          <span className="font-semibold text-[#345c2c] dark:text-green-300">Difficulty:</span> {tipDetails.difficulty}
        </p>
        <p>
          <span className="font-semibold text-[#345c2c] dark:text-green-300">Availability:</span> {tipDetails.availability}
        </p>
        <p>
          <span className="font-semibold text-[#345c2c] dark:text-green-300">Shared By:</span> {tipDetails.userName} ({tipDetails.userEmail})
        </p>
      </div>

      <div className="pt-6">
        <h3 className="text-xl font-semibold text-[#2d4722] dark:text-green-400 mb-2">🌱 Description</h3>
